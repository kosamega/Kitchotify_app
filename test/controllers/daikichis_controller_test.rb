...
class DaikichisControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create daikichi" do
    assert_difference("Daikichi.count") do
      post daikichis_url, params: { daikichi: { counting_votes_date: @daikichi.counting_votes_date, designer_id: @daikichi.designer_id, name: @daikichi.name, released: @daikichi.released } }
    end
  ...
  test "should update daikichi" do
    patch daikichi_url(@daikichi), params: { daikichi: { counting_votes_date: @daikichi.counting_votes_date, designer_id: @daikichi.designer_id, name: @daikichi.name, released: @daikichi.released } }
