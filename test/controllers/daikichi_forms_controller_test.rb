...
class DaikichiFormsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create daikichi_form" do
    assert_difference("DaikichiForm.count") do
      post daikichi_forms_url, params: { daikichi_form: { one_point: @daikichi_form.one_point, two_point: @daikichi_form.two_point, three_point: @daikichi_form.three_point, albums_for_voting: @daikichi_form.albums_for_voting, closed: @daikichi_form.closed, name: @daikichi_form.name } }
    end
  ...
  test "should update daikichi_form" do
    patch daikichi_form_url(@daikichi_form), params: { daikichi_form: { one_point: @daikichi_form.one_point, two_point: @daikichi_form.two_point, three_point: @daikichi_form.three_point, albums_for_voting: @daikichi_form.albums_for_voting, closed: @daikichi_form.closed, name: @daikichi_form.name } }
